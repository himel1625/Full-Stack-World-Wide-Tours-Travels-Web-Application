    ...
    <div className='sticky top-0 z-10 shadow-md'>
      <div className='container  flex  items-center h-20 justify-between'>
        ...
        <div
          ...
          } absolute md:relative top-20 right-0 w-full md:w-auto md:flex md:justify-center md:items-center md:space-x-6 md:top-0 md:right-0 p-4 md:p-0 transition-transform duration-700 ease-in-out `}
        >
